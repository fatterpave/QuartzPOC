...
namespace QuartzConsole
{
    class Program
    {
        ...
        public class AlarmAction : BaseJob
        {
            public override async Task Execute(IJobExecutionContext context)
            {
                ...
                Console.WriteLine(String.Format("Alarm {0} given update and sent to queue for processing (await) - time is: {1}", alarm.NimId,DateTime.Now.ToLongTimeString()));
